...
public class activity_showPlace extends AppCompatActivity {
   ...
   /* public class crdMapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
        ...
        protected static final String TAG = "crdMapsActivity";
